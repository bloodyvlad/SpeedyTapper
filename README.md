...
- A confirmed profile nickname that normalizes case-insensitively to `misha_boy` unlocks a cosmetic Misha pixel-cat easter egg. Misha idles below the Profile shortcut throughout non-game views, then perches above the Speed streak meter during a run and turns toward the side of each accepted board tap. The easter egg changes no scoring, coins, ranking, or gameplay rule.
