...
container="pimpopom-gc-autolink-mariadb-$$"
cleanup() {
...
command -v docker >/dev/null 2>&1 || {
    echo "Docker is required for the MariaDB Game Center concurrency test." >&2
    exit 1
}
...
php "$(dirname "$0")/game-center-autolink-mariadb.php"
