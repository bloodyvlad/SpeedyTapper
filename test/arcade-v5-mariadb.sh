...
container="pimpopom-arcade-v5-mariadb-$$"
...
docker run -d --name "$container" -e MARIADB_ROOT_PASSWORD=root \
    -e MARIADB_DATABASE=speedytapper_arcade_v5 -p 127.0.0.1::3306 mariadb:11.4 >/dev/null
...
SPEEDYTAPPER_ARCADE_V5_DSN="mysql:host=127.0.0.1;port=${port};dbname=speedytapper_arcade_v5;charset=utf8mb4" \
    php "$(dirname "$0")/arcade-v5-persistence.test.php"
